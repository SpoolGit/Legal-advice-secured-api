...
class TestLegalAdviceAPI:
    ...
    def test_off_topic_rejection(self):
        ...
        response = client.post(
            "/api/v1/legal-advice",
            json={"user_id": "test_user_123", "input_prompt": "How do I cook pasta?"},
        )
    ...
    def test_invalid_user_id(self):
        ...
        response = client.post(
            "/api/v1/legal-advice",
            json={"user_id": "invalid@user!", "input_prompt": "What are my rights?"},
        )
    ...
    def test_empty_input_prompt(self):
        ...
        response = client.post(
            "/api/v1/legal-advice",
            json={"user_id": "test_user_123", "input_prompt": ""},
        )
    ...
    def test_input_too_long(self):
        ...
        response = client.post(
            "/api/v1/legal-advice",
            json={"user_id": "test_user_123", "input_prompt": long_input},
        )
